      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '48px', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '100%' }}>
          ...
          <p style={{
            ...
            CTRL is a harm reduction app for people who actually use substances — no lectures, no judgment. The drug library, combo checker, and journal are all yours to explore. The Shop and Drug Scan are concepts for now. This is a prototype we're genuinely excited about. Dig in.
          </p>
        </div>
