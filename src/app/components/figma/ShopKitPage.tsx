...
import imgBoxKit32 from '../../../assets/Testing Kit.png';
import { BottomNav } from '../ui/BottomNav';
import { LAYOUT } from '../../constants/layout';

type NavTab = 'Home' | 'Checker' | 'Scan' | 'Library' | 'Journal';

interface ShopKitPageProps {
  onBack: () => void;
  onSearchOpen?: () => void;
  onTabChange?: (tab: NavTab) => void;
}

export function ShopKitPage({ onBack, onSearchOpen, onTabChange }: ShopKitPageProps) {
  return (
    <div className="relative w-full h-screen bg-[#0D0D0D] overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 h-[56px]">
        ...
        <div className="relative h-full flex flex-col z-10">
          ...
          <div className="h-[56px] flex items-center justify-between px-4">
            ...
            {/* Title */}
            <p className="text-[#F1F1F1] text-[18px] font-bold tracking-[0.36px]">Testing Kit</p>
      ...
      >
        {/* Hero image — no background color, image only */}
